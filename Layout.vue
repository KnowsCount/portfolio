 ...
 * @LastEditTime: 2020-12-06 20:13:38
...
<template>
  <div class="terminal__container">
    ...
    <model v-model="info">
      ...
      <div><b>source: </b>execute file content as command</div>
      <div><b>alias: </b>create short-cut commands</div>
      <div><b>help: </b>print all commands</div>
      <div><b>cd: </b>go to directory</div>
      <div><b>echo: </b>print input content</div>
